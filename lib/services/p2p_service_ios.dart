// iOS implementation of P2PService using MultipeerConnectivity via MethodChannel.
import 'dart:async';
...
class IOsP2PService implements P2PService {
  ...
  void _setupEventListener() {
    _eventSubscription = _eventChannel.receiveBroadcastStream().listen(
      ...
      onError: (error) {
        print('[iOS P2P] Event stream error: $error');
      },
    );
  }
  ...
  @override
  String? get hostConnectionInfo => null; // MultipeerConnectivity handles connections internally
  ...
  Future<Session> createSession({required String leaderName}) async {
    ...
    try {
      ...
      print('[iOS P2P] Failed to create session: $e');
      rethrow;
    }
  ...
  Future<void> startDiscovery() async {
    try {
      ...
      print('[iOS P2P] Failed to start discovery: $e');
    }
  }
  ...
  Future<void> stopDiscovery() async {
    try {
      ...
      print('[iOS P2P] Failed to stop discovery: $e');
    }
  }
  ...
  Future<Session> joinSession({
    ...
    // connectionInfo is ignored - MultipeerConnectivity handles connections via discovery
    try {
      ...
      print('[iOS P2P] Failed to join session: $e');
      rethrow;
    }
  }
  ...
  Future<void> startGame({required String sessionId}) async {
    try {
      ...
      print('[iOS P2P] Failed to start game: $e');
    }
  }
  ...
  Future<void> endGame({required String sessionId}) async {
    try {
      ...
      print('[iOS P2P] Failed to end game: $e');
    }
  }
  ...
  Future<void> updateTimerSetting({
    ...
    try {
      ...
      print('[iOS P2P] Failed to update timer: $e');
    }
  }
  ...
  Future<void> updateStartPlayer({
    ...
    try {
      ...
      print('[iOS P2P] Failed to update start player: $e');
    }
  }
  ...
  Future<void> reorderPlayers({
    ...
    try {
      ...
      print('[iOS P2P] Failed to reorder players: $e');
    }
  }
  ...
  Future<void> passTurn({
    ...
    try {
      ...
      print('[iOS P2P] Failed to pass turn: $e');
    }
  }
  ...
  Future<void> leaveSession({required String sessionId}) async {
    try {
      ...
      print('[iOS P2P] Failed to leave session: $e');
    }
  ...
  Future<void> dispose() async {
    ...
    try {
      ...
      print('[iOS P2P] Failed to cleanup: $e');
    }
  }
}
